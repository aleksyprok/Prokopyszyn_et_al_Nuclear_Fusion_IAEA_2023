...
\begin{itemize}
    ...
    \item Add RWM active control section
    \item Make graph of G=0 losses vs bscale 
    \item Discuss optimum phase for ELM suppression maximises movement of the X-point.
    \item Show distribution of losses for axisymmetric field, ripple field, n=2, n=3, n=4, in-vessel, ex-vessel ELM suppression, RWM active control coils
